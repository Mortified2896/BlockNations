...
public class MainMenuUITKView : MonoBehaviour
{
    ...
    private const string DevPuzzleReviewPuzzleId = "Puzzle #001";
    private const string DevPuzzleReviewPuzzleLogId = "001";
    private const string DevPuzzleReviewSituationType = "Adjacent Empty Enemy City Capture";
    private const string DevPuzzleReviewSituationTypeLogId = "AdjacentEmptyEnemyCityCapture";
    private const string DevPuzzleReviewNotLaunchedStatusText = "Not launched yet.";
    private const string DevPuzzleReviewVerifiedStatusText = "Verified: Puzzle #001 looks correct.";
    private const string DevPuzzleReviewFlaggedStatusText = "Flagged: Puzzle #001 needs another look.";
    private const string DevPuzzleReviewNoMorePuzzlesStatusText = "No more puzzles yet.";
    private const string DevPuzzleReviewLaunchedStatusText = "Puzzle #001 launched.";
    private const string DevPuzzleReviewLaunchFailedStatusText = "Puzzle #001 could not be opened. See console.";
    private const string DevPuzzleReviewLaunchUnavailableStatusText = "Puzzle launch is only available in Editor / Development builds.";
    ...
    private Button devPuzzleReviewVerifyButton;
    private Button devPuzzleReviewFlagButton;
    private Button devPuzzleReviewNextButton;
    private Button devPuzzleReviewLaunchButton;
    ...
    private bool TryInitializeView()
    {
        ...
        SetVisible(puzzleModeButton, IsDevBuild());
        SetVisible(puzzleModePanel, false);
    ...
    private void CacheElements()
    {
        ...
        devPuzzleReviewVerifyButton = root.Q<Button>("DevPuzzleReviewVerifyButton");
        devPuzzleReviewFlagButton = root.Q<Button>("DevPuzzleReviewFlagButton");
        devPuzzleReviewNextButton = root.Q<Button>("DevPuzzleReviewNextButton");
        devPuzzleReviewLaunchButton = root.Q<Button>("DevPuzzleReviewLaunchButton");
    ...
    private void BindButtons()
    {
        ...
        if (devPuzzleReviewVerifyButton != null)
        {
            devPuzzleReviewVerifyButton.clicked += HandleDevPuzzleReviewVerifyClicked;
        }

        if (devPuzzleReviewFlagButton != null)
        {
            devPuzzleReviewFlagButton.clicked += HandleDevPuzzleReviewFlagClicked;
        }

        if (devPuzzleReviewNextButton != null)
        {
            devPuzzleReviewNextButton.clicked += HandleDevPuzzleReviewNextClicked;
        }

        if (devPuzzleReviewLaunchButton != null)
        {
            devPuzzleReviewLaunchButton.clicked += HandleDevPuzzleReviewLaunchClicked;
        }
    ...
    private void HandleDevPuzzleReviewVerifyClicked()
    {
        SetDevPuzzleReviewStatus(DevPuzzleReviewVerifiedStatusText);
        Debug.Log(BuildDevPuzzleReviewLogLine("Verified"));
    }

    private void HandleDevPuzzleReviewFlagClicked()
    {
        SetDevPuzzleReviewStatus(DevPuzzleReviewFlaggedStatusText);
        Debug.LogWarning(BuildDevPuzzleReviewLogLine("FlaggedSuspicious"));
    }

    private void HandleDevPuzzleReviewNextClicked()
    {
        SetDevPuzzleReviewStatus(DevPuzzleReviewNoMorePuzzlesStatusText);
    }

    private void HandleDevPuzzleReviewLaunchClicked()
    {
#if UNITY_EDITOR
        if (!DevPuzzleReviewRunner.Run())
        {
            SetDevPuzzleReviewStatus(DevPuzzleReviewLaunchFailedStatusText);
        }
        else
        {
            SetDevPuzzleReviewStatus(DevPuzzleReviewLaunchedStatusText);
        }
#else
        SetDevPuzzleReviewStatus(DevPuzzleReviewLaunchUnavailableStatusText);
#endif
    }
    ...
    private void ShowPuzzleModePanel()
    {
        ...
        {
            puzzleModeStatusLabel.text = DevPuzzleReviewNotLaunchedStatusText;
        }
    }

    private void SetDevPuzzleReviewStatus(string statusText)
    {
        if (puzzleModeStatusLabel != null)
        {
            puzzleModeStatusLabel.text = statusText;
        }
    }

    private static string BuildDevPuzzleReviewLogLine(string verdict)
    {
        return $"[DevPuzzleReview] puzzle={DevPuzzleReviewPuzzleLogId} type={DevPuzzleReviewSituationTypeLogId} verdict={verdict}";
    }
